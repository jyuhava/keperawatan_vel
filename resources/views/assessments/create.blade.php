<x-dashboard-layout>
    <div class="p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                <h1 class="text-2xl font-bold text-slate-800">Tambah Assessment</h1>
                <p class="text-slate-600">Input data assessment keperawatan</p>
            </div>
            ...
            <form method="POST" action="{{ route('assessments.store') }}" class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <textarea name="chief_complaint" rows="3" class="w-full border border-slate-300 rounded-lg px-3 py-2" 
                              placeholder="Deskripsikan keluhan utama pasien..." required>{{ old('chief_complaint') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="medical_history" rows="3" class="w-full border border-slate-300 rounded-lg px-3 py-2" 
                              placeholder="Riwayat penyakit sekarang dan terdahulu...">{{ old('medical_history') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="physical_examination" rows="4" class="w-full border border-slate-300 rounded-lg px-3 py-2" 
                              placeholder="Hasil pemeriksaan fisik head to toe...">{{ old('physical_examination') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="psychological_assessment" rows="3" class="w-full border border-slate-300 rounded-lg px-3 py-2" 
                              placeholder="Kondisi psikologis, mood, kecemasan, dll...">{{ old('psychological_assessment') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="social_assessment" rows="3" class="w-full border border-slate-300 rounded-lg px-3 py-2" 
                              placeholder="Dukungan keluarga, kondisi sosial ekonomi, dll...">{{ old('social_assessment') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="spiritual_assessment" rows="3" class="w-full border border-slate-300 rounded-lg px-3 py-2" 
                              placeholder="Kebutuhan spiritual, praktik keagamaan, dll...">{{ old('spiritual_assessment') }}</textarea>
